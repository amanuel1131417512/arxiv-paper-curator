...
2. **Install Requirements**
   ...
   - **Docker:** Use Docker to manage containers efficiently.
...
3. **Run the Application**
   ...
   - For macOS users, drag the application to your Applications folder, then open it.
   - For Linux users, open a terminal, navigate to the folder where the downloaded file is located, then enter `./your_file_name` to start.
...
Our application is designed with simplicity in mind. You will find easy navigation and clear instructions.

### RAG Systems
The core of the application revolves around RAG systems. This allows you to learn about how AI utilizes both information retrieval and generation processes.

### Hands-On Learning
Each section of the application provides practical examples and exercises. Engage with the material deeply and learn by doing.

## 📊 System Requirements
To use the arXiv Paper Curator smoothly, ensure your system meets these specifications:
- **Processor:** Dual-core 2.0 GHz or higher.
- **RAM:** 4GB minimum is recommended for the best experience.
